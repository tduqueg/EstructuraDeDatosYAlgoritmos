...
class WebCrawler:
    ...
    def __init__(self):
        ...
        #Debemos evitar visitar el mismo sitio una y otra vez
    ...
    def crawl(self, start_url):
        ...
        #Este es un algoritmo Breadth First search estandar
        while queue:

            actual_url = queue.pop(0)
            print(actual_url)

            #Este es el codigo html en crudo sitio we en cuetion (URL)
